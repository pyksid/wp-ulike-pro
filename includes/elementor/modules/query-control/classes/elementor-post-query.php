<?php
namespace WpUlikePro\Includes\Elementor\Modules\QueryControl\Classes;

use Elementor\Widget_Base;
use WpUlikePro\Includes\Elementor\Modules\QueryControl\Module;
...
class Elementor_Post_Query {
	...
	public function get_query() {
		 ...
		 */
		do_action( 'wp_ulike_pro/query/query_results', $query, $this->widget );
	...
	public function get_query_args() {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters( 'wp_ulike_pro/query/get_query_args/current_query', $current_query_vars );
		 ...
		 * @param Widget_Base $widget     An instance of Elementor widget.
		 */
		$this->query_args = apply_filters( 'wp_ulike_pro/query/query_args', $this->query_args, $this->widget );
	...
	protected function set_common_args() {
		...
		$post_type = $this->get_widget_settings( 'post_type' );
		if ( 'by_id' === $post_type ) {
			$post_types = wp_ulike_pro_get_public_post_types();
	...
	public function pre_get_posts_query_filter( $wp_query ) {
		if ( $this->widget ) {
			 ...
			 * @param Widget_Base $widget   An instance of Elementor widget
			 */
			do_action( "wp_ulike_pro/query/{$query_id}", $wp_query, $this->widget );
		}
	}
