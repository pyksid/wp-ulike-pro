...
/**
 * Elementor 'MostLikedTopics' widget.
 *
 * Elementor widget that displays an 'MostLikedTopics' with lightbox.
 *
 * @since 1.0.0
 */
class MostLikedTopics extends Widget_Base {

    /**
     * Get widget name.
     *
     * Retrieve 'MostLikedTopics' widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_name() {
        return 'wp_ulike_top_topics';
    }

    /**
     * Get widget title.
     *
     * Retrieve 'MostLikedTopics' widget title.
     *
     * @since 1.0.0
     * @access public
     *
     ...
     * Get widget icon.
     *
     * Retrieve 'MostLikedTopics' widget icon.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    /**
     * Register 'MostLikedTopics' widget controls.
     *
    ...
    /**
    * Render MostLikedTopics widget output on the frontend.
    *
    ...
    */
    protected function render() {
        ...
        $topics   = wp_ulike_get_most_liked_posts(
            $settings['number'],
            array( 'topic', 'reply' ),
            'topic',
        ...
        $this->add_render_attribute( 'wrapper', 'class', 'wp-ulike-most-liked-widget wp-ulike-most-liked-topics-wrapper' );
        ...
        if( empty( $topics ) ){
            ...
            $title = bbp_get_forum_title( $topic->ID );
        ?>
            <div id="wp-ulike-topic-<?php echo esc_attr( $topic->ID ); ?>" class="wp-ulike-topic wp-ulike-item">
                ...
                <div class="wp-ulike-entry-header">
                    <<?php echo $settings['title_tag']; ?> class="wp-ulike-entry-title">
                        <a href="<?php echo get_permalink( $topic->ID ); ?>" title="<?php echo esc_attr( $title ); ?>">
                            <?php echo $title; ?>
                        </a>
                ...
                <div class="wp-ulike-entry-content">
                    <p><?php echo $topic->post_content; ?></p>
                </div>
                <?php endif; ?>
                ...
                <div class="wp-ulike-entry-info">
                    <div class="wp-ulike-entry-date">
                        ...
                        echo human_time_diff( strtotime( $topic->post_date ) ) . ' ' . $settings['ago_text'];
                        ?>
                    </div>
                    ...
                    <?php
                        ...
                        $likes       = wp_ulike_pro_get_counter_value( $topic->ID, 'topic', 'like', $is_distinct  );
                        $dislikes    = wp_ulike_pro_get_counter_value( $topic->ID, 'topic', 'dislike', $is_distinct );
                        if( ! empty( $likes ) ){
                        ?>
